Una declaración o bloque `if` se entiende como una estrucutra 'condicional', ya que evalúa si una expresión es `true`, para así ejecutar una instrucción, o él código que contiene.
